        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              <SidebarLinkGroup
                activeCondition={
                  pathname.includes("rubros") ||
                  pathname.includes("productos") ||
                  pathname.includes("unidad-medida")
                }
              >
                {(handleClick, open) => {
                  return (
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/unidad-medida"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/unidad-medida" && "text-white"
                              }`}
                            >
                              Unidad Medida
                            </Link>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname.includes("expedientes") ||
                  pathname.includes("expedientes-ue")
                }
              >
                {(handleClick, open) => {
                  return (
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/expedientes"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/expedientes" && "text-white"
                              }`}
                            >
                              Expedientes
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/expedientes-ue"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/expedientes-ue" && "text-white"
                              } `}
                            >
                              Expedientes UE
                            </Link>
